...
class NumberHelperTest < ActionView::TestCase
  ...
  def test_number_helpers_escape_delimiter_and_separator
    ...
    assert_equal "9&lt;script&gt;&lt;/script&gt;86 KB", ERB::Util.html_escape(number_to_human_size(10100, :separator => "<script></script>"))

    assert_equal "1&lt;script&gt;&lt;/script&gt;01", ERB::Util.html_escape(number_to_human(1.01, :separator => "<script></script>"))
    assert_equal "100&lt;script&gt;&lt;/script&gt;000 Quadrillion", ERB::Util.html_escape(number_to_human(10**20, :delimiter => "<script></script>"))
  end
